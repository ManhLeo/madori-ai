...
def build_generation_prompt(
    ...
    prompt = "\n".join(
        [
            ...
            "- keep the entrance, balcony, kitchen, bath room, wash room, toilet, doors and windows unchanged",
            ...
            "Bath Room, Toilet, Wash Room: keep all fixtures in place; do not add large furniture; add only tiny storage details if space allows.",
            "",
            "Furniture plan:",
            *furniture_lines,
            "",
