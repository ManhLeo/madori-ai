...
class Settings(BaseSettings):
    ...
    openai_analysis_max_output_tokens: int = Field(default=8192, validation_alias="OPENAI_ANALYSIS_MAX_OUTPUT_TOKENS")
    openai_analysis_json_retry_attempts: int = Field(default=2, validation_alias="OPENAI_ANALYSIS_JSON_RETRY_ATTEMPTS")
    openai_image_model: str = Field(default="gpt-image-1", validation_alias="OPENAI_IMAGE_MODEL")
    openai_image_timeout_seconds: int = Field(default=180, validation_alias="OPENAI_IMAGE_TIMEOUT_SECONDS")
    openai_image_retry_attempts: int = Field(default=2, validation_alias="OPENAI_IMAGE_RETRY_ATTEMPTS")
    openai_image_retry_delay_seconds: int = Field(default=5, validation_alias="OPENAI_IMAGE_RETRY_DELAY_SECONDS")
