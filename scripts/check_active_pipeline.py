...
def main() -> int:
    ...
    print(f"openai_image_timeout_seconds: {getattr(settings, 'openai_image_timeout_seconds', None)}")
    print(f"openai_image_retry_attempts: {getattr(settings, 'openai_image_retry_attempts', None)}")
    print(f"openai_image_retry_delay_seconds: {getattr(settings, 'openai_image_retry_delay_seconds', None)}")
